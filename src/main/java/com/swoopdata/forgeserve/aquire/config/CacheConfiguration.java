package com.swoopdata.forgeserve.aquire.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("forgeServeAquire");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("forgeServeAquire");
        ...
        config.getMapConfigs().put("com.swoopdata.forgeserve.aquire.domain.*", initializeDomainMapConfig(jHipsterProperties));
